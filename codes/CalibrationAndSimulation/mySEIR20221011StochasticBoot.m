...
%%% This code estimates beta values in the SEIR-like model from reported 
%%% infections, not the model parameters for beta.
...
%%%% are carried out by LSQNONLIN. The model parameters are estimated from
