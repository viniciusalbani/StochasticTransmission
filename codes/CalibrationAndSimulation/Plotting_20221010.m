close all; clc;
H = [100,100,700,400];
datas = [t_span(len0-len-s-2),datetime(2021,10:12,01),t_span(len0+extend)];
yt = 0:0.1:0.6;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
figure
hold on
...
plot([datas(jj),datas(jj)],[0,0.6],':k')
end
for jj = 1:length(yt)
...
hold off
print('-dpng',['beta_PerMR',num2str(vv)])
...
set(gca,'FontSize',16,'FontName','Arial')
hold off
print('-dpng',['beta_PerLMR',num2str(vv)])
...
set(gca,'FontSize',16,'FontName','Arial')
hold off
print('-dpng',['beta_PerMRJ',num2str(vv)])
...
set(gca,'FontSize',16,'FontName','Arial')
hold off
print('-dpng',['beta_PerLMRJ',num2str(vv)])

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
datas = [t_span(len0),datetime(2021,11,19),datetime(2021,12,[3,17]),t_span(len0+extend)];
yt = (0:1:6)*1E5;
figure
hold on
grid off
...
for jj = 1:length(datas)
h=plot([datas(jj),datas(jj)],[yt(1),yt(end)],':k');
