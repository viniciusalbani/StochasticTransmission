function  yprime = seir_death_age_beta_b2Heston(t,y, params,beta,NSamples)
...
yprime(2*NSamples+1:3*NSamples) = sigma*E-(nu+mu)*I;              
yprime(3*NSamples+1:4*NSamples) = nu*I-reinf*R;
yprime(4*NSamples+1:5*NSamples) = mu*I;
end